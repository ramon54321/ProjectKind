...
fn serialize_deserialize_single() {
    ...
    let person_typed = Person {
        name: String::from("Alfred the Great"),
    };
    let person_two_typed = Person {
        name: String::from("Bordaux"),
    };
    ...
    let person_string_expected = r#"{"name":"Alfred the Great"}"#;
    let person_two_string_expected = r#"{"name":"Bordaux"}"#;
...
fn serialize_deserialize_array() {
    ...
    let person_typed = Person {
        name: String::from("Charlie the 2nd"),
    };
    let person_two_typed = Person {
        name: String::from("Dexter"),
    };
    ...
    let person_array_string_expected = r#"[{"name":"Charlie the 2nd"},{"name":"Dexter"}]"#;
