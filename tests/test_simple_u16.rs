...
fn serialize_deserialize_single() {
    ...
    let person_typed = Person { age: 27 };
    let person_two_typed = Person { age: 50 };
    ...
    let person_string_expected = r#"{"age":27}"#;
    let person_two_string_expected = r#"{"age":50}"#;
...
fn serialize_deserialize_array() {
    ...
    let person_array_string_expected = r#"[{"age":27},{"age":50}]"#;
