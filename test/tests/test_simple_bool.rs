...
fn serialize_deserialize_single() {
    let person_layout = Layout {
        ...
        fields: Some(vec![Layout {
            name: String::from("is_old"),
            kind: LayoutKind::Bool,
            fields: None,
        }]),
    };

    let person_typed = Person { is_old: false };
    let person_two_typed = Person { is_old: true };
    ...
    let person_string_expected = r#"{"is_old":false}"#;
    let person_two_string_expected = r#"{"is_old":true}"#;
...
fn serialize_deserialize_array() {
    ...
    let person_typed = Person { is_old: true };
    let person_two_typed = Person { is_old: false };
    ...
    let person_array_string_expected = r#"[{"is_old":true},{"is_old":false}]"#;
